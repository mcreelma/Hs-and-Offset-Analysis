...
# bined whiskered box plots by every ~50m
# smaller text on graph axis
# add date text to the graphs
# add 
# scale bar on loaded axis


# normalize difference histogram y axis
# look at interactive map for what differences are where we have weather stations
# run road rasters through at high DPI

# get data from within shape file:
# https://rasterio.readthedocs.io/en/latest/topics/georeferencing.html # not as useful as next one
# https://gis.stackexchange.com/questions/260304/extract-raster-values-within-shapefile-with-pygeoprocessing-or-gdal
# https://gis.stackexchange.com/questions/199727/gdal-python-cut-geotiff-image-with-geojson-file/199764#199764
...
# figure switch for saving figures to output folder
# 0 is off and 1 is on
fig_switch = 0 # CURRENTLY ASPIRATIONAL


#%% File Names and Directories

# set the file path for where the rasters are located
# file_path = "C:/Users/Owner/Documents/School/Thesis Related Work/Snow-On DEM's/"
file_path = "H:/Finals/Rasters/"

# Shape file for road extraction 
# road = "Bogus_Road_Shape_File_CRS32611.shp"
road = "Bogus_Road_20m Buffer_planar.shp"

# determine the flights (be sure to include the '.tif' ending)
flights = ["0303_U2.tif", # march 3rd unadjusted flight
           "0310_U2.tif",  # march 10th unadjusted flight
           "0310_A.tif", # March 10th adjusted flight
           "0310_A2.tif"] # March 10th adjusted flight with interp min 

# set the file name for later
file_name = [flights[first],flights[second]]
...
# SD = Snow_Diff.data.copy() # extract data from xarray use.copy() to create a different copy
...
#%% implement ground control points
###############################################################################
